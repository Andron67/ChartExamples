...
window.title("Примеры простроения графиков")
...
btnChart4 = tk.Button(window, text = "График 4", font = ('Helvetica', 10, 'bold'))
btnChart4.place(x = 40, y = 265, width = 90, height = 30)

lblChart4 = tk.Label(text = "График синуса matplotlib")
...
btnChart6 = tk.Button(window, text = "График 6", font = ('Helvetica', 10, 'bold'))
btnChart6.place(x = 40, y = 365, width = 90, height = 30)

lblChart6 = tk.Label(text = "Гистограмма")
...
lblChart7 = tk.Label(text = "График синуса matplotlib")
lblChart7.place(x = 170, y = 422)

# Добавление кнопки и метки для графика 8
btnChart8 = tk.Button(window, text = "График 8", font = ('Helvetica', 10, 'bold'), command = chart8.plot_chart)
btnChart8.place(x = 40, y = 465, width = 90, height = 30)

lblChart8 = tk.Label(text = "Гистограмма")
