...
def plot_chart():
    ...
    df_normal_a = pd.DataFrame(data = normal_data_a, columns = ['score']).assign(group = "Croup A")
...
def plot_chart2():
    ...
    df_normal_a = pd.DataFrame(data = normal_data_a, columns = ['score']).assign(group = "Croup A")
    df_normal_b = pd.DataFrame(data = normal_data_b, columns = ['score']).assign(group = "Croup B")
